...
let API_KEY = "1a81c723377b191a258de4fafa7f087f";
 ...
 * 
 * call: api.openweathermap.org/data/2.5/weather?q={city name}&appid={API key}
 * 
 * 
 */
getWeatherData = (city) => {
...
showWeatherData = (weatherData) => {
  ...
  let icon_view =`<img src="${icon_url}">`; 

  //CODE GOES HERE
  document.getElementById('city-name').innerText= weatherData.name ;
  document.getElementById('weather-type-icon').innerHTML= icon_view;
